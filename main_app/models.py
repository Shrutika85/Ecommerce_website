...
class brand (models.Model):
    ...
    brand_desc=models.CharField(max_length=50)
    # brand_image=models.ImageField()

class category (models.Model):
    cat_id=models.IntegerField(unique=True, db_index=True,primary_key=True)
    cat_name=models.CharField(max_length=30)
    cat_desc=models.CharField(max_length=30)
    # cat_image=models.ImageField(max_length=30)
...
class customer(models.Model):
    ...
    cust_pass=models.CharField(max_length=30)
    cust_contact=models.CharField(max_length=30)
...
class sales(models.Model):
    ...
    sales_payment_mode=models.CharField(max_length=30)
